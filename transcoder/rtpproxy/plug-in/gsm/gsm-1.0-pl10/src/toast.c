...
/* $Header: /home/xubuntu/berlios_backup/github/tmp-cvs/semsivr/Repository/transcoder/rtpproxy/plug-in/gsm/gsm-1.0-pl10/src/toast.c,v 1.1 2006/02/16 19:52:05 sayer Exp $ */
...
static void version P0()
{
	printf( "%s 1.0, version %s\n",
		progname,
		"$Id: toast.c,v 1.1 2006/02/16 19:52:05 sayer Exp $" );
}
